package br.com.android.maximatech.historicodepedidos.view.adapter
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence): FilterResults {
                ...
                if (!constraint.isNullOrEmpty()) {
                    val arrayListHistoricoDePedidos: ArrayList<HistoricoDePedido> =
                    ...
                    for (i in historicoDePedidosFiltrado.indices) {
                        if (historicoDePedidosFiltrado[i].nomeDoCliente!!.toUpperCase()
                            ...
                            historicoDePedido.nomeDoCliente =
                                historicoDePedidosFiltrado[i].nomeDoCliente
