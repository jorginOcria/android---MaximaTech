package br.com.tisistema.maximatech.historicodepedidos.controller
...
import br.com.tisistema.maximatech.historicodepedidos.dao.HistoricoDePedidoRepositoryService
import br.com.tisistema.maximatech.historicodepedidos.dao.HistoricoDePedidoRestService
import br.com.tisistema.maximatech.historicodepedidos.model.HistoricoDePedido
import br.com.tisistema.maximatech.historicodepedidos.model.HistoricoDePedidoDto
...
class ControllerHistoricoDePedido(application: Application) : AbstractController(application) {
    ...
    fun verificarConexaoComAInternet() {
        if (getConexaoDisponivel(context)) {
            ...
            verificarSeHistoricoDePedidoNoBancoDeDados()
        }
    }

    private fun verificarSeHistoricoDePedidoNoBancoDeDados() {
